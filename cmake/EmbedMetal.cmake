# EmbedMetal.cmake
# Converts Metal library binary to C header file

# Required variables:
# SHADER_NAME - Name for the shader array
# METALLIB_FILE - Input metallib file
# OUTPUT_FILE - Output header file

if(NOT SHADER_NAME OR NOT METALLIB_FILE OR NOT OUTPUT_FILE)
    message(FATAL_ERROR "SHADER_NAME, METALLIB_FILE, and OUTPUT_FILE must be defined")
endif()

# Read the binary file
file(READ "${METALLIB_FILE}" SHADER_DATA HEX)

# Get file size
file(SIZE "${METALLIB_FILE}" SHADER_SIZE)
...
set(HEADER_CONTENT "// Auto-generated Metal shader library
// Source: ${METALLIB_FILE}
