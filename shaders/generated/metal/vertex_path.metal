...
vertex main0_out main0(main0_in in [[stage_in]], constant type_Uniforms& Uniforms [[buffer(0)]])
{
    ...
    out.out_var_COLOR2 = float4(0.0);
    out.out_var_COLOR3 = float4(0.0);
    out.out_var_COLOR4 = float4(0.0);
    out.out_var_COLOR5 = float4(0.0);
    out.out_var_COLOR6 = float4(0.0);
    out.out_var_COLOR7 = float4(0.0);
    return out;
}
